...
__RCSID__ = "53fdf07 (2016-04-19 10:27:34 +0200) Federico Stagni <federico.stagni@cern.ch>"
    ...
    for fileName in os.listdir( dirToDo ):
      ...
      if os.path.isdir( objPath ):
        ...
        if fileName.find( '.py', len( fileName ) - 3 ) == len( fileName ) - 3 :
          ...
          changed = False
          for keyWord, cmdArgs in ( ( '53fdf07 (2016-04-19 10:27:34 +0200) Federico Stagni <federico.stagni@cern.ch>', '--pretty="%h (%ad) %an <%aE>" --date=iso' ),
                                    ( '53fdf07612d81da2905aa49bd05a703711d0f69c', '--pretty="%H"' ) ):
