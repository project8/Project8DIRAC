...
try:
  MySQLdb.server_init( ['--defaults-file=/srv/dirac/etc/my.cnf', '--datadir=/opt/mysql/db'], ['mysqld'] )
...
__RCSID__ = "0066045 (2016-07-26 13:02:45 +0200) Federico Stagni <federico.stagni@cern.ch>"
